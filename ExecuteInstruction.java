...
public class ExecuteInstruction {
	...
	public static int Execute(String OPcode, int Readdata1, int Readdata2, String extended, int pc, String regdst) {
		...
		// sheleha
		// int a = (zero==0)? (ALUresult == 0? 1:0 ) :1 ;
		...
		Main.execute = instruction1
				+ " in Execute Stage." /* +"\nNextPc: "+Main.prepend(Integer.toBinaryString(Main.pc), 32) */ + "\n"
				+ "zero flag: " + Main.cashe3[5] + " branch address: " + Main.prepend(Integer.toBinaryString(branch), 32) + "\n"
